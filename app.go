...
// versionName: optional version name (digits only); empty = auto-generate.
// icons: map of icon path -> webp bytes (generated by frontend canvas).
func (a *App) BuildAPK(projectDir, appName, versionName string, iconsBase64 map[string]string) (*builder.BuildResult, error) {
